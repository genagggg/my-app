...
const Navbar = () => {
	...
	<div className={s.item}><NavLink to="/setting"  activeClassName={s.activeLink}>Settings</NavLink></div>
<div className={s.item} activeClassName={s.activeLink}><NavLink to="/users">Users</NavLink></div>
</nav>
}
